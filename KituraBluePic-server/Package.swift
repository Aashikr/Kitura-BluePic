...
let package = Package(
    ...
    dependencies: [
        ...
        .Package(url: "https://github.com/IBM-Swift/Kitura-CredentialsFacebookToken.git", majorVersion: 0, minor: 15),
        .Package(url: "https://github.com/IBM-Swift/Kitura-CredentialsGoogleToken.git", majorVersion: 0, minor: 15)
    ],
